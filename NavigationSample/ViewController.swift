...
//  NavigationSample
//
//  Created by NhatPV on 16/05/2023.
//
...
class ViewController: UIViewController, MGLMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let defaultS: ActionHandler = {_ in self.startStyledNavigation() }
    ...
    @objc func didLongPress(tap: UILongPressGestureRecognizer) {
        ...
        let waypoint = Waypoint(coordinate: arrivel!, name: "Dropped Pin #\(waypoints.endIndex + 1)")
